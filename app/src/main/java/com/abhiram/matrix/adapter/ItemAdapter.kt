...
class ItemAdapter(val list : ArrayList<GiveItem>, val inflate : View,val sharedPreferncesHelper: SharedPreferncesHelper,val context : Context): RecyclerView.Adapter<ItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.name.text = item.VehicleModel
