...
class GrabLFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val inflate = inflater.inflate(R.layout.fragment_grab_l, container, false)
        read()
        val sharedPreferences = SharedPreferncesHelper()
        sharedPreferences.SharedPreferncesHelperInit(requireContext())
        val recyclerview : RecyclerView = inflate.findViewById(R.id.rcvv)
